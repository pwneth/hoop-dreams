...
vi.mock('../components/Stats.js', () => ({ renderIndividualStats: () => '<div>MyStats</div>' }));
vi.mock('../components/BetCard.js', () => ({ renderBetCard: () => '<div>BetCard</div>' }));
vi.mock('../components/ActionNeeded.js', () => ({ renderActionNeededSection: () => '<div>ActionNeeded</div>' }));
